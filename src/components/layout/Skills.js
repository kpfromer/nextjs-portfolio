...
export default () => (
  <Section bg="backgroundAlt">
    ...
    <Text>
      ...
      to learn about computer systems in preparation for college. Building this computer system has
      given me a great appreciation for all the hard work past computer scientists have done for us.
    </Text>
  </Section>
);
